...
<head>
    ...
    <title>Internal Server Error | Infilearn</title>
    <style>
        ...
        .back-btn #arrow-img{
            animation: MoveArrow 1500ms infinite ease-in-out;
        }
...
<body>
    ...
    <div class="error-page-back-to-home-page">
        <button class="back-btn" onclick="window.location.href = '../index.php';">
            <span id="arrow-img">
                <img src="../content/icons/left-arrow.svg" alt="arrow" width="30px">
            </span>
